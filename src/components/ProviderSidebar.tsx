      ...
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-sidebar-primary">Portal Prestador</span>
            <span className="text-xs text-sidebar-foreground/60">Serviços & Financeiro</span>
          </div>
        </div>
      </SidebarHeader>
